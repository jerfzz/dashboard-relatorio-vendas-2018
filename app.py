...
if st.session_state.pagina_ativa == "Home":
    ...
    col_graf1, col_graf2 = st.columns([2.5,1.5])
    ...
    with col_graf1:
        if not df_filtrado.empty:
            ...
            grafico_cidade = px.bar(venda_cidade, x='Cidade', y='Total', text='Total', 
                                    title="Vendas por Cidade", labels={'Total': '', 'Cidade': ''})
            ...
            grafico_cidade.update_layout(title_x=0.5, yaxis={'categoryorder':'total ascending'})
